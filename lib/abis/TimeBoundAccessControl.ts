/**
 * TimeBoundAccessControl ABI — auto-sourced from Hardhat compilation artifact.
 * Do not hand-edit; re-run: npm run compile:contracts
 */
export const TimeBoundAccessControlAbi = [
  {
    "inputs": [],
