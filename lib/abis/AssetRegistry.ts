/**
 * AssetRegistry ABI — auto-sourced from Hardhat compilation artifact.
...
export const AssetRegistryAbi = [
  ...
  {
    "inputs": [],
    "name": "RecipientCredentialInvalid",
    "type": "error"
  },
  {
    "inputs": [],
    "name": "SameSignerNotAllowed",
    "type": "error"
  },
  {
    "inputs": [],
