...
export default function OnboardingPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-graphite-950 px-4 py-10">
      <GradientBanner
        className="w-full max-w-lg"
        eyebrow="Welcome to Praman Setu"
        title="A soulbound identity in five steps"
        description="No passwords, ever — HR verifies you once, then everything downstream is cryptographic and guardian-recoverable."
      ...
      <Card className="w-full max-w-lg">
        ...
        {step === 1 && (
          <div className="flex flex-col items-center gap-4 py-6 text-center">
            ...
            <div className="mono-value rounded-xl border border-graphite-800 bg-graphite-900 px-3 py-2 text-[11px] text-ink-500">
        ...
        {step === 2 && (
          <div className="flex flex-col items-center gap-4 py-6 text-center">
            ...
            <div className="mono-value rounded-2xl border border-verified-500/25 bg-verified-500/10 px-3 py-2 text-[12px] text-verified-400">
              {newDid}
            </div>
          </div>
        )}
        ...
        {step === 4 && (
          <div className="flex flex-col items-center gap-4 py-6 text-center">
            ...
            <div className="w-full rounded-xl border border-graphite-800 bg-graphite-900 p-3 text-left text-[12px]">
